...
const newModel = ({ session, userInfo }: Props) => {
  ...
  const handleSubmit = async () => {
    ...
    const res = await axios({
      method: "post",
      url: "https://liamkyoung.live/train",
      data: formData,
    ...
    <div className="flex flex-row">
      ...
      <div className="flex flex-col w-5/6 px-20 py-6 space-y-4">
          ...
          <div className="flex flex-col justify-start px-5 w-full">
            ...
            <div className="flex justify-even items-center space-x-6 text-gray-400">
              ...
              >
                ...
                <p>
                  Use our algorithm to categorize your images. Think classifying
                  the species of a bird.{" "}
                </p>
              </div>
              <div
              ...
              >
                ...
                <p>
                  Find the numerical meaning behind your data. Think home prices
                  related to square footage and location.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col justify-start px-5 w-full">
            <p className="font-medium py-1 w-full">Upload your dataset here:</p>
            <div className="flex">
